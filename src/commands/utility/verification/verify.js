// rely on oAuth2 for verification
// should check roblox group ranks to determine appoint_rank eligibility
// should create a thing in the database to link the discord user to the roblox user
